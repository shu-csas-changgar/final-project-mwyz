...
// employeeid, deviceType, deviceTypeid
  ...
  add_existing_device(dct){
    var dt = new Date();
    var datetime = dt.toISOString().substr(0, 10) + " " + dt.toTimeString().substr(0, 8);
    return "insert into abc.devices (deviceid, devicetypeid, leased, employeeid, updated) values("+"\'"+dct["deviceTypeid"]+"\'"+"," + "\'"+ dct["leased"] + "\'"+  ","
  + "\'"+ dct["empid"] + "\'"+ ","+"\'"+datetime+"\'"+"); ";
  }
...
var dct = {"phone": "45345365", "address": "ergsgdg", "email": "@", "vendor": "sdf", "stock": "500","deviceType": "laptop", "deviceid": "325", "officeid": "34", "deviceTypeid": "234", "empid": "32", "issue" : "werwer", "components": "sfd" ,"price": "35435"};
var Q = new Query();
console.log(Q.updateReservation(dct));
